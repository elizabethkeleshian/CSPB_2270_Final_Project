...
public:
    ...
    [[nodiscard]] const Matrix4& getMatrix() const {
        return matrix_;
    }
    ...
    static Vector2 localToGlobalCoordinates(const Transform& parent, const Transform& child,
                                            const Vector2& point);
    static Vector2 globalToLocalCoordinates(const Transform& parent, const Transform& child,
                                            const Vector2& point);
